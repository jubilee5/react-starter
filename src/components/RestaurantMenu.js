...
const RestaurantMenu = () => {
    ...
    const dummy = "dummy data"; // this is a dummy variable that we will pass as a prop to the restaurant category component and items list component to show props drilling. We will avoid props drilling using context API .
